...
SquidGameFi SquidGameMetaverse SquidGameNFT
...
$$\   $$ |$$ |  $$ |$$ |  $$ |$$ |$$ |  $$ |   $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |$$   ____|
\$$$$$$  |\$$$$$$$ |\$$$$$$  |$$ |\$$$$$$$ |$$\\$$$$$$  |$$ |  $$ |$$ |$$ |$$ |  $$ |\$$$$$$$\ 
 \______/  \____$$ | \______/ \__| \_______|\__|\______/ \__|  \__|\__|\__|\__|  \__| \_______|
                $$ |                                                                           
                $$ |                                                                           
                \__|                                               
*/
...
// Dependency file: contracts/squid/IterableMapping.sol
...
// Dependency file: contracts/squid/SQUIDGAMEDividendTracker.sol
...
// import "contracts/squid/IterableMapping.sol";
...
contract SQUIDGAMEDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SQUIDGAMEONLINE contract."
        );
    }
...
// Root file: contracts/squid/SquidGameOnline.sol
...
// import "contracts/squid/SQUIDGAMEDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract SquidGameOnline is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    SQUIDGAMEDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        address rewardAddress_, //reward  
        address routerAddress_, //router 
        address marketingAddress_,//marketing wallet
        address dividendTrackerAddress_,//dividendTracker
        address antiBotAddress_,// anti bot
        uint256[3] memory feeSettings, // rewards, liquidity, marketing
        uint256 minimumTokenBalanceForDividends_
    ) payable ERC20(name_, symbol_) {
        rewardToken = rewardAddress_;
        _marketingWalletAddress = marketingAddress_;
        require(
            msg.sender != _marketingWalletAddress,
            "Owner and marketing wallet cannot be the same"
        );

        pinkAntiBot = IPinkAntiBot(antiBotAddress_);
        ...
        dividendTracker = SQUIDGAMEDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "SQUIDGAMEONLINE: The dividend tracker already has that address"
        );

        SQUIDGAMEDividendTracker newDividendTracker = SQUIDGAMEDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "SQUIDGAMEONLINE: The new dividend tracker must be owned by the SQUIDGAMEONLINE token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "SQUIDGAMEONLINE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SQUIDGAMEONLINE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "SQUIDGAMEONLINE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SQUIDGAMEONLINE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SQUIDGAMEONLINE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SQUIDGAMEONLINE: Cannot update gasForProcessing to same value"
        );
